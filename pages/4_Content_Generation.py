"""Page 4: Content Generation — Run AI generation with Claude."""
...
st.caption("Generate optimised product content using Claude AI.")
...
with col2:
    st.metric("Model", settings.get("model", "claude-sonnet-4-20250514").split("-")[1].title())
with col3:
